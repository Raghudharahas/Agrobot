...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'agrobot.urdf'
    xacro_file = "agrobot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "agrobot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("agrobot"), "rviz", "display_default.rviz"]
    )
